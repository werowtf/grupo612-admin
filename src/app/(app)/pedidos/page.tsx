      ...
      <div className="space-y-6">
        <header className="flex flex-wrap items-start justify-between gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-brand-600 px-3 py-1.5 text-sm text-brand-600 hover:bg-brand-600 hover:text-white"
          >
        ...
        <form method="get" className="flex flex-wrap items-center gap-3">
          ...
          <button
            type="submit"
            className="cursor-pointer rounded-lg border border-brand-600 px-3 py-1.5 text-sm text-brand-600 hover:bg-brand-600 hover:text-white"
          >
            Ver
          </button>
        </form>
